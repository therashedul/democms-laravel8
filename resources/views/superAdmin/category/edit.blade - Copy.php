            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    @php
                        $id = $cat->id;
                    @endphp
                    <x-forms.category.catedit :id="$id" :categories="$categories" />
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                            ...
                            <input type="hidden" name="image_id" id="image_id" value="{{ $cat->image_id }}">
                            <input type="hidden" name="image_name" id="image_name" value="{{ $cat->category_img }}">
                            <input type="hidden" name="alt" id="alt_value" value="{{ $cat->alt }}">
                            <input type="hidden" name="title" id="title_value" value="{{ $cat->title }}">
                            <input type="hidden" name="caption" id="caption_value" value="{{ $cat->caption }}">
                            <input type="hidden" name="description" id="description_value" value="{{ $cat->description }}">
                        </div>
                    </div>


                    <button type=" submit" class="btn btn-primary text-center" id="submit-all">Update</button>
                    {!! Form::close() !!}
                </div>
            </div>
        </div>
    </div>
    {{-- <x-forms.category.cateditmodal /> --}}
    <!-- Modal -->
