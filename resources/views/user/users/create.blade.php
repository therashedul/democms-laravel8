            ...
            <div class="card">
                <div class="card-header">Create User
                    <span class="float-right">
                        <a class="btn btn-primary" href="{{ route('user.users') }}">Users</a>
                    </span>
                </div>

                <div class="card-body">
                    {!! Form::open(['route' => 'user.users.store', 'method' => 'POST']) !!}
            ...
            <div class="modal-content">
                    ...
                    <div class="file-manager">
                        <div class="file-manager-left">
                            <form id="dropzoneForm" enctype="multipart/form-data" class="dropzone"
                                action="{{ route('user.users.upload') }}">
                                @csrf
                ...
                <div class="modal-footer">
                    <div class="file-manager-footer">
                        {{-- <form action="{{ route('user.users.delete') }}">
