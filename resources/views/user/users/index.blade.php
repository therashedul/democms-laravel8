                                ...
                                <tr>
                                    ...
                                    <td>
                                                            ...
                                                            @if (stristr($name, 'user'))
                                                                ...
                                                                @if ($value == 'list')
                                                                    <a class="btn btn-secondary btn-sm"
                                                                        href="{{ route('user.users.show', $user->id) }}"><i
                                                                            class="fas fa-eye"></i></a>
                                                                @elseif ($value == 'create')
                                                                    {{-- <a class="btn btn-primary"
                                                                    href="{{ route('user.users.create') }}">New
                                                                    user</a> --}}
                                                                @elseif ($value == 'active')
                                                                    @if ($user->status_id == 1)
                                                                        <a href="{{ route('user.users.publish', $user->id) }}"
                                                                            class="btn btn-info btn-sm"><i
                                                                                class="fa fa-arrow-circle-up"
                                                                                aria-hidden="true"></i></a>
                                                                    @else
                                                                        <a href="{{ route('user.users.unpublish', $user->id) }}"
                                                                ...
                                                                @elseif ($value == 'edit')
                                                                    <a class="btn btn-primary btn-sm"
                                                                        href="{{ route('user.users.edit', $user->id) }}"><i
                                                                            class="fas fa-edit"></i></a>
                                                                @elseif ($value == 'delete')
                                                                    {!! Form::open([
                                                                        'method' => 'DELETE',
                                                                        'route' => ['user.users.destroy', $user->id],
                                        ...
                                        {{-- <a class="btn btn-success"
                                            href="{{ route('user.users.show', $user->id) }}">Show</a>
                                        <a class="btn btn-primary"
                                            href="{{ route('user.users.edit', $user->id) }}">Edit</a>


                                        {!! Form::open(['method' => 'DELETE', 'route' => ['user.users.destroy', $user->id], 'style' => 'display:inline']) !!}
