        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    <a href="{{ route('comment.archive') }}" class="btn btn-sm btn-primary pull-right">Archive
                        comment</a>
                            ...
                            <form method="post" action="{{ route('post.multipledelete') }}">
                                ...
                                @foreach ($comment as $value)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($value->status == 1)
                                                <a href="{{ route('comments.publish', $value->id) }}"
                                                    class="btn btn-sm btn-info "><i class="fa fa-arrow-circle-up"
                                                        aria-hidden="true"></i></a>
                                            @else
                                                <a href="{{ route('comments.unpublish', $value->id) }}"
                                                    class="btn btn-sm btn-warning">
                                                    <i class="fa fa-arrow-circle-down " aria-hidden="true"></i>
                                                </a>
                                            @endif

                                            <a href="{{ route('comments.view', $value->id) }}"
                                                class="btn btn-sm btn-success">
                                                <i class="fa fa-eye" aria-hidden="true"></i></a>

                                            <a href="{{ route('comments.distroy', $value->id) }}"
