...
@section('content')
    ...
    <div class="col-md-12 col-sm-12  ">
        <a href="{{ route('comments') }}" class="btn btn-sm btn-info d-flax mb-2 pull-right"><i class="fas fa-arrow-left"></i>
            Back</a>
        <div class="x_panel">
            <div class="x_title">
                <h2>Comment List</h2>
            ...
            <div class="x_content">
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            <form method="post" action="{{ route('comment.multipledelete') }}">
                                {{ csrf_field() }}
                                ...
                                @foreach ($comment as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('comment.return', $value->id) }}"
