        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="table-responsive">
                    {{-- <a href="{{ route('admin.post.archive') }}" class="btn btn-sm btn-info pull-right">Archive
                        Post</a> --}}
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            ...
                            <form method="post" action="{{ route('admin.post.archivemultipledelete') }}">
                                {{ csrf_field() }}
                                ...
                                @foreach ($posts as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.post.archivereturn', $value->id) }}"
                                                class="btn btn-sm btn-success"><i class="fas fa-window-restore"></i></a>
                                            <a href="{{ route('admin.post.archivedistroy', $value->id) }}"
