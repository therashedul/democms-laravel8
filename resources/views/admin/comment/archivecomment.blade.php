...
@section('content')
    ...
    <div class="col-md-12 col-sm-12  ">
        <a href="{{ route('admin.comments') }}" class="btn btn-sm btn-info d-flax mb-2 pull-right"><i
            ...
            <div class="x_content">
                <div class="table-responsive">
                    <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                            <form method="post" action="{{ route('admin.comment.multipledelete') }}">
                                {{ csrf_field() }}
                                ...
                                @foreach ($comment as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.comment.return', $value->id) }}"
