...
@section('content')
    <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="clearfix"></div>
                <a class="btn btn-primary mb-2 ml-2" href="{{ route('admin.artical.create') }}">Add Artical</a>
                    ...
                    <tbody>
                        ...
                        @foreach ($categories as $value)
                            ...
                            <tr>
                                ...
                                <td> <a href="{{ route('admin.artical.edit', $value->id) }}"
                                        class="btn btn-sm btn-primary"><i class="fa fa-pencil-square"
                                            aria-hidden="true"></i></a>
                                    <a href="{{ route('admin.artical.deleted', $value->id) }}"
