...
class Displaycrud{  public function postsingle($slug, $id=null){        
        //post view auto incriment
        Post::findOrFail($id)->increment('views');
        ...
        ->get();
        return view('blog.post', compact('post','categories','postmeta','reletedpost'));
